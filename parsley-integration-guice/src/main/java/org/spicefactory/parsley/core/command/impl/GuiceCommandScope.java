...
public class GuiceCommandScope implements Scope {
	...
	public <T> void seed(Key<T> key, T value) {
		...
		//		checkState(!scopedObjects.containsKey(key), "A value for the key %s was " + "already seeded in this scope. Old value: %s New value: %s",
