...
public final class SwingViewManager implements ViewManager, ContainerListener, ContextListener {
	...
	private final Map<Container, ViewRoot> viewRoots = new IdentityHashMap<Container, SwingViewManager.ViewRoot>();

	private final static Map<Container, ViewManager> viewRootRegistry = new IdentityHashMap<Container, ViewManager>();

	@Inject
	SwingViewManager(Context c, @Nullable ViewSettings s) {
		context = c;
	...
	@Override
	public void addViewRoot(Object view) {
	...
	public void addViewRoot(Container view) {
		...
		logger.info("Adding view root {}/{}.", view.getName(), view.getClass());
	...
	@Override
	public void removeViewRoot(Object view) {
		// TODO Auto-generated method stub
	...
	public void removeViewRoot(Container view) {
		...
		if (viewRoot != null) {
			logger.info("Removing view root {}/{}.", view.getName(), view.getClass());
